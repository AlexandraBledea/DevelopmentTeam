...
void MemberWindow::initGUI() {
    ...
    this->buttonsLayout->addWidget(this->issueLineEdit, 0, 1);
...
void MemberWindow::reportIssue() {
    string description = this->issueLineEdit->text().toStdString();
    ...
    try{
        ...
        QMessageBox::critical(this, "Error", "The given issue alreadye exists!");
        return;
    }
}
